    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(blank=True, choices=[('USD', 'USD'), ('XAF', 'XAF'), ('EUR', 'EUR')], max_length=5, null=True)),
                ('receiver_amount', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Receiver Amount')),
                ('receiver_currency', models.CharField(blank=True, choices=[('USD', 'USD'), ('XAF', 'XAF'), ('EUR', 'EUR')], max_length=5, null=True)),
                ('receiver_type', models.CharField(blank=True, choices=[('famille', 'famille'), ('entreprise', 'entreprise')], max_length=12, null=True)),
                ('payment_mode', models.CharField(blank=True, choices=[('CARTE_CREDIT', 'Carte de Credit'), ('PAYPAL', 'Paypal'), ('ORANGE_MONEY', 'Orange Money'), ('MTN_MOMO', 'MTN MoMo'), ('PossaPay', 'PossaPay')], default='PossaPay', max_length=12, null=True)),
                ('frais', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='fees Amount')),
                ('amount_assur', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='assur Amount')),
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('lock', 'lock'), ('completed', 'Completed'), ('failed', 'Failed')], default='pending', max_length=20, verbose_name='Transaction Status')),
                ('transaction_type', models.CharField(choices=[('service_payment', 'Service Payment'), ('recharge', 'Recharge'), ('envoi', 'Envoi'), ('retrait', 'Retrait')], default='user_to_user', max_length=20, verbose_name='Transaction Type')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Date Created')),
